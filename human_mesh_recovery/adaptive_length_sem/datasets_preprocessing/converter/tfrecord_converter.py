...
class TFRecordConverter(abc.ABC):
    ...
    def add_arguments(self):
        self.parser.add_argument('--data_directory', required=False, default='C://paper//hmr2.0-master//raw_data/',
                                 help='Directory containing the original dataset')
        self.parser.add_argument('--output_directory', required=False, default='C://paper//hmr2.0-master//tf_data1/',
                                 help='Directory where to store the generated TFRecord')
        self.parser.add_argument('--dataset_name', required=False, default='mpii',
