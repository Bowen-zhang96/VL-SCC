...
class Config(object):
    ...
    # LOG_DIR = os.path.join(ROOT_DATA_DIR, 'logs', datetime.now().strftime("%d%m%Y-%H%M%S")) lsp-lspet-mpii-smpl-3D-True1-sensing-adaptive1-base20-max250-2-mpii3donly-3
    LOG_DIR = os.path.join(ROOT_PROJECT_DIR, 'logs', 'sensing-2-c100-ori')
    ...
    Rate_Lambda = 0.0008    #   0.0015 (80)  0.0008(c100)  0.0003(c125)
    Latent_dim=10
